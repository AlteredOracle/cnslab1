#include <stdio.h> #include <stdlib.h> #include <unistd.h> int encrypt();

int decrypt();
char plaintext[50]={0},ciphertext[50]={0}; int c,d;
...
int decrypt()
{
static int p=0,q=0; printf("\nCiphertext : ");getchar();

while((d=getchar()) != '\n')
{
ciphertext[p++]=(char)d; plaintext[q++]=(char)(d-3);
